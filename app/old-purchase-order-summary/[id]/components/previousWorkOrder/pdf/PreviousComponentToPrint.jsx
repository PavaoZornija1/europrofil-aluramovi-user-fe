...
const PreviousComponentToPrint = forwardRef((props, ref) => {
  const { data } = props;
...
PreviousComponentToPrint.displayName = "PreviousComponentToPrint";
export default PreviousComponentToPrint;

...
function PreviousWorkOrderMain({
  showSavedButton,
  setShowSavedButton,
  ...
  return (
    <div>
      <div className="m-auto mt-2 flex max-w-[1250px] flex-col items-center justify-center gap-4 p-2">
        ...
        <div className="flex w-full flex-col justify-around gap-2 overflow-hidden rounded-lg border bg-slate-300 text-white sm:flex-row "></div>
...
export default PreviousWorkOrderMain;
